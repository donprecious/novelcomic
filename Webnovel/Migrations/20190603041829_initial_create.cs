        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NovelSectionId = table.Column<int>(nullable: true),
                    Title = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_NovelSections", x => x.Id);
                    table.ForeignKey(
                        name: "FK_NovelSections_Novels_NovelId",
                        column: x => x.NovelId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(nullable: true),
                    NovelId = table.Column<int>(nullable: false),
                    NovelSectionId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Chapters_NovelSections_NovelSectionId",
                        column: x => x.NovelSectionId,
                        principalTable: "NovelSections",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Chapters_NovelSectionId",
                table: "Chapters",
